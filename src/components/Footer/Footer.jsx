...
const Footer = () => {
  return (
    <footer className=" footer text-white  bg-blue-600  py-10 ">
      <div className="container mx-auto grid md:grid-cols-4 grid-cols-2 items-center">
        <aside>
          <svg
            width="50"
            height="50"
        ...
        <nav className="grid grid-rows-1 gap-3">
